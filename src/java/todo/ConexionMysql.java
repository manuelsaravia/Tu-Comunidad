...
public class ConexionMysql {
    ...
    */
    ...
    private static  String bd = "tucomuni_prueba";
    private static  String login = "tucomuni_manuel";
    private static  String password = "1090479041";    
    private static  String host = "tucomunidadcolombia.co";
    private static  String url = "jdbc:mysql://" + host + ":3306/"+bd;
    private static  String controlador = "com.mysql.jdbc.Driver";
    private static  JDBCMiddler jdbc;
