<%-- 
    Document   : cargarImagenTributarios
    Created on : 15/12/2015, 09:14:53 PM
    Author     : Manuel
--%>
...
<%     
    ...
    String ruta = getServletContext().getRealPath("/archivos/tributarios/").replace("./", "/");
                        String dir = ruta + "\\";
                        ...
                        response.sendRedirect("tributarios.jsp");
%>
