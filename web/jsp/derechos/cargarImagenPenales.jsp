<%-- 
    Document   : cargarImagenPenales
    Created on : 15/12/2015, 08:55:49 PM
    Author     : Manuel
--%>
...
<%     
    ...
    String ruta = getServletContext().getRealPath("/archivos/penales/").replace("./", "/");
                        String dir = ruta + "\\";
                        ...
                        response.sendRedirect("penales.jsp");
%>
