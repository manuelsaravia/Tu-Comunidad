<%-- 
    Document   : cargarImagenPublicos
    Created on : 15/12/2015, 09:45:53 PM
    Author     : Manuel
--%>
...
<%     
    ...
    String ruta = getServletContext().getRealPath("/archivos/publicos/").replace("./", "/");
                        String dir = ruta + "\\";
                        ...
                        response.sendRedirect("publicos.jsp");
%>
