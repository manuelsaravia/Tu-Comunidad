<%-- 
    Document   : cargarImagenAdministrativos
    Created on : 15/12/2015, 06:51:45 PM
    Author     : Manuel
--%>
...
<%     
    ...
    String ruta = getServletContext().getRealPath("/archivos/administrativos/").replace("./", "/");
                        String dir = ruta + "\\";
                        ...
                        response.sendRedirect("administrativos.jsp");
%>
