<%-- 
    Document   : cargarImagenCiviles
    Created on : 15/12/2015, 09:21:59 PM
    Author     : Manuel
--%>
...
<%     
    ...
    String ruta = getServletContext().getRealPath("/archivos/civiles/").replace("./", "/");
                        String dir = ruta + "\\";
                        ...
                        response.sendRedirect("civiles.jsp");
%>
