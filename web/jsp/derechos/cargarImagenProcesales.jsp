<%-- 
    Document   : cargarImagenProcesales
    Created on : 15/12/2015, 09:01:33 PM
    Author     : Manuel
--%>
...
<%     
    ...
    String ruta = getServletContext().getRealPath("/archivos/procesales/").replace("./", "/");
                        String dir = ruta + "\\";
                        ...
                        response.sendRedirect("procesales.jsp");
%>
