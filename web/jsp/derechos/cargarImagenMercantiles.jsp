<%-- 
    Document   : cargarImagenMercantiles
    Created on : 15/12/2015, 09:32:50 PM
    Author     : Manuel
--%>
...
<%     
    ...
    String ruta = getServletContext().getRealPath("/archivos/mercantiles/").replace("./", "/");
                        String dir = ruta + "\\";
                        ...
                        response.sendRedirect("mercantiles.jsp");
%>