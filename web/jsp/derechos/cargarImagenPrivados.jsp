<%-- 
    Document   : cargarImagenPrivados
    Created on : 15/12/2015, 09:50:47 PM
    Author     : Manuel
--%>
...
<%     
    ...
    String ruta = getServletContext().getRealPath("/archivos/privados/").replace("./", "/");
                        String dir = ruta + "\\";
                        ...
                        response.sendRedirect("privados.jsp");
%>
