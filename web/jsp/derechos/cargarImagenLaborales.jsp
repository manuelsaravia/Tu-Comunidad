<%-- 
    Document   : cargarImagenLaborales
    Created on : 15/12/2015, 09:38:14 PM
    Author     : Manuel
--%>
...
<%     
    ...
    String ruta = getServletContext().getRealPath("/archivos/laborales/").replace("./", "/");
                        String dir = ruta + "\\";
                        ...
                        response.sendRedirect("laborales.jsp");
%>
