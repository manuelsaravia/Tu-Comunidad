<%-- 
    Document   : cargarImagenFinancieros
    Created on : 15/12/2015, 09:07:50 PM
    Author     : Manuel
--%>
...
<%     
    ...
    String ruta = getServletContext().getRealPath("/archivos/financieros/").replace("./", "/");
                        String dir = ruta + "\\";
                        ...
                        response.sendRedirect("financieros.jsp");
%>
